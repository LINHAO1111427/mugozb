...
#define Current_TISDK_Version @"3040040100"
...
#define kScreenMaxLength (MAX(SCREEN_WIDTH, SCREEN_HEIGHT))
//是否为iphoneX以后机型
#define kISiPhoneXX (((UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPhone)) && kScreenMaxLength > 811.0)
//底部安全区高度
...
#define TiUIClassifyViewHeight 45
...
#define FaceNarrowingValue 15 // 窄脸拉条默认参数
