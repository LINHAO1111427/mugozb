...
@property(nonatomic,strong)NSArray *meizhuangModArr;

@property(nonatomic,strong)NSArray *cheekRedModArr;

@property(nonatomic,strong)NSArray *eyelashModArr;

@property(nonatomic,strong)NSArray *eyebrowsModArr;
