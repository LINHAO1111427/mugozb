...
//    NSString *url = [NSString stringWithFormat:@"/resource/getFont", fontId];
    NSDictionary *param = @{ @"fontId":@(fontId) };
    [client GET:@"/resource/getFont" parameters:param completionHandler:^(NSURLResponse *response, id responseObject, NSError *error) {
...
//            }
            ...
            AliyunEffectResourceModel *fontModel = [[AliyunEffectResourceModel alloc] initWithDictionary:responseObject[@"data"] error:nil];
