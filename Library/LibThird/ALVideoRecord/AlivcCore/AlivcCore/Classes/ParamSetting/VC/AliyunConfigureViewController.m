...
- (void)updatevideoOutputVideoSize {
   ...
   // NSLog(@"过滤文字videoSize:w:%f  h:%f"), _mediaInfo.outputSize.width, _mediaInfo.outputSize.height);
...
- (void)setupParamData {
    ...
    cellModel6_1.placeHolder = kLocalizationMsg(@"当视频大于1080p时，转码到1080p下");
