...
#import <AliyunVideoSDKBasic/AliyunErrorCode.h>
#import <MBProgressHUD/MBProgressHUD.h>
#if (SDK_VERSION != SDK_VERSION_BASE)
#import <AliyunVideoSDKBasic/AliyunImporter.h>
#import <AliyunVideoSDKBasic/AliyunNativeParser.h>
#endif
    ...
    dispatch_async(_compressQueue, ^{
        for (int i = 0; i < assets.count; i++) {
            ...
            if (!info.phAsset) {
               ...
               // NSLog(@"过滤文字--------->frameRate:%f  GopSize:%zd"),asset.frameRate,avParser.getGopSize);
                //分辨率过大
...
-(void)dealloc {
   // NSLog(@"过滤文字--------------compositionViewController dealloc-----------"));
}
@end
