...
- (void)recordButtonTouchUp {
   // NSLog(@"过滤文字 DD----  %f    %f  - %f"), CFAbsoluteTimeGetCurrent(), _startTime, (CFAbsoluteTimeGetCurrent() - _startTime));
...
- (void)deleteButtonClick:(UIButton *)buttonClick {
   // NSLog(@"过滤文字delete   %d"), self.deleteButton.selected);
