...
#import "HttpApiApiGuild.h"




@implementation HttpApiApiGuild
...
{
NSString *strUrl=[NSString stringWithFormat:@"%@%@",[HttpClient getBaseUrl],@"/api/guild/queryGuildList",nil];
        ...
        if(code==1)
        {
            ...
            if([idArray isKindOfClass:[NSArray class]])
            {
                ...
                for (NSDictionary *dic in dataArray) {
                    GuildDtoModel *handle = [GuildDtoModel getFromDict:dic];
...
{
NSString *strUrl=[NSString stringWithFormat:@"%@%@",[HttpClient getBaseUrl],@"/api/guild/getGuildAll",nil];
NSDictionary *dictPara=@{@"_uid_":@([HttpClient getUid]) ,@"_token_":[HttpClient getToken],@"_OS_":[HttpClient getOSType],@"_OSV_":[HttpClient getOSVersion],@"_OSInfo_":[HttpClient getOSInfo]};
 ...
 [HttpClient requestPostWithPath:strUrl param:dictPara success:^(id dataBody) {
        ...
        if(code==1)
        {
            ...
            if([idArray isKindOfClass:[NSArray class]])
            {
                NSArray*  dataArray=idArray;
                for (NSDictionary *dic in dataArray) {
                    AdminUserModel *handle = [AdminUserModel getFromDict:dic];
                    [retArr addObject:handle];
                }
            }
        }
...
{
NSString *strUrl=[NSString stringWithFormat:@"%@%@",[HttpClient getBaseUrl],@"/api/guild/getGuildLiveRoom",nil];
NSDictionary *dictPara=@{@"_uid_":@([HttpClient getUid]) ,@"_token_":[HttpClient getToken],@"_OS_":[HttpClient getOSType],@"_OSV_":[HttpClient getOSVersion],@"_OSInfo_":[HttpClient getOSInfo]
,@"guildId":@(guildId)};
 ...
 [HttpClient requestPostWithPath:strUrl param:dictPara success:^(id dataBody) {
        ...
        if(code==1)
        {
            ...
            if([idArray isKindOfClass:[NSArray class]])
            {
                NSArray*  dataArray=idArray;
                for (NSDictionary *dic in dataArray) {
                    LiveRoomInfoVOModel *handle = [LiveRoomInfoVOModel getFromDict:dic];
                    [retArr addObject:handle];
                }
            }
        }
