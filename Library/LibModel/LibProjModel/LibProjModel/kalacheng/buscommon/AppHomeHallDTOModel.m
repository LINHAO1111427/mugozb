...
#import "AppHomeHallDTOModel.h"
 ...
 @implementation AppHomeHallDTOModel  
...
{
AppHomeHallDTOModel* sumMdl=list[i];
...
{
NSMutableArray<AppHomeHallDTOModel*>* mdlArr=[[NSMutableArray alloc] init];
...
{
AppHomeHallDTOModel* model=[[AppHomeHallDTOModel alloc]init];
