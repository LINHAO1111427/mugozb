...
#import "ApiUsersVideoCommentsModel.h"
 ...
 @implementation ApiUsersVideoCommentsModel  

+ (NSDictionary *)modelContainerPropertyGenericClass{
    return @{@"replyList" : [ApiUsersVideoCommentsModel class]};
}
...
{
ApiUsersVideoCommentsModel* sumMdl=list[i];
NSDictionary* subDict =[sumMdl modelToJSONObject];
...
{
NSMutableArray<ApiUsersVideoCommentsModel*>* mdlArr=[[NSMutableArray alloc] init];
...
{
ApiUsersVideoCommentsModel* model=[[ApiUsersVideoCommentsModel alloc]init];
...
//            target.replyList=nil;
        }else
        {
            ...
            {
		  [target.replyList addObject:[[ApiUsersVideoCommentsModel alloc]init]];
            [ApiUsersVideoCommentsModel cloneObj:source.replyList[i] target:target.replyList[i]];
            }
        }
