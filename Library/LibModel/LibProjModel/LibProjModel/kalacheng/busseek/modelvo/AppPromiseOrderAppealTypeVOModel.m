...
#import "AppPromiseOrderAppealTypeVOModel.h"
 ...
 @implementation AppPromiseOrderAppealTypeVOModel  
...
{
AppPromiseOrderAppealTypeVOModel* sumMdl=list[i];
...
{
NSMutableArray<AppPromiseOrderAppealTypeVOModel*>* mdlArr=[[NSMutableArray alloc] init];
...
AppPromiseOrderAppealTypeVOModel* sumMdl=[AppPromiseOrderAppealTypeVOModel getFromDict:subDic];
...
{
AppPromiseOrderAppealTypeVOModel* model=[[AppPromiseOrderAppealTypeVOModel alloc]init];
