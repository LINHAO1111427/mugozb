...
#import "UserAppealTypeVOModel.h"
 ...
 @implementation UserAppealTypeVOModel  
...
{
UserAppealTypeVOModel* sumMdl=list[i];
...
{
NSMutableArray<UserAppealTypeVOModel*>* mdlArr=[[NSMutableArray alloc] init];
...
UserAppealTypeVOModel* sumMdl=[UserAppealTypeVOModel getFromDict:subDic];
...
{
UserAppealTypeVOModel* model=[[UserAppealTypeVOModel alloc]init];
