...
#import "HttpApiUserInvitation.h"




@implementation HttpApiUserInvitation
...
{
NSString *strUrl=[NSString stringWithFormat:@"%@%@",[HttpClient getBaseUrl],@"/api/user/userInvitationList",nil];
        ...
        if(code==1)
        {
            ...
            if([idArray isKindOfClass:[NSArray class]])
            {
                ...
                for (NSDictionary *dic in dataArray) {
                    UserInvitationVOModel *handle = [UserInvitationVOModel getFromDict:dic];
