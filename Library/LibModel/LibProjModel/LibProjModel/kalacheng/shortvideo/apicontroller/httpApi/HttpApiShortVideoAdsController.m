...
#import "HttpApiShortVideoAdsController.h"




@implementation HttpApiShortVideoAdsController
...
{
NSString *strUrl=[NSString stringWithFormat:@"%@%@",[HttpClient getBaseUrl],@"/api/shortvideo/getShortVideoWatchAdsVO",nil];
        ...
        if(code==1)
        {
            ...
            if([idArray isKindOfClass:[NSArray class]])
            {
                ...
                for (NSDictionary *dic in dataArray) {
                    ShortVideoWatchAdsModel *handle = [ShortVideoWatchAdsModel getFromDict:dic];
