...
@implementation GiftNobilityShowObj
...
- (GiftBannerView *)bannerV{
    if (!_bannerV) {
        GiftBannerView *bgV = [[GiftBannerView alloc] initWithFrame:CGRectMake(-_superV.size.width, liveVIPGiftBannerY, _superV.size.width, 50)];
...
- (void)playNextGift{
    ...
    if (_itemArr.count) {
        ...
        [self.bannerV showView:GiftBannerForVIP giftModel:giftModel];
        [self showBannerView];
