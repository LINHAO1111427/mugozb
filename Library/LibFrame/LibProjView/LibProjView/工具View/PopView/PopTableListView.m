...
{
    CGRect frame = CGRectMake(0, 0, 100, titles.count*44);
...
//        cell.textLabel.textColor = [UIColor whiteColor];
        UIView *lineView = [[UIView alloc] initWithFrame:CGRectMake(0, 43.5, 100, .2)];
    ...
    if (self.imgNames.count>indexPath.row) {
        if ([self.imgNames[indexPath.row] length] != 0) {
