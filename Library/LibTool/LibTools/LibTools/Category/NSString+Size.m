...
- (UIImage *)make_imageWithColor:(UIColor *)color
    ...
    // text
    CGSize textSize = [self sizeWithAttributes:textAttributes];
    [self drawInRect:CGRectMake((size.width - textSize.width) / 2, (size.height - textSize.height) / 2, textSize.width, textSize.height) withAttributes:textAttributes];
