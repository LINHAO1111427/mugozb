...
NSString *const ShortVideoReportItemCellIdentifier = @"ShortVideoReportItemCellIdentifier";
@implementation ShortVideoReportItemCell
...
- (void)setSelectItem:(BOOL)selectItem{
    if (selectItem) {
        ...
        _rightImage.backgroundColor = kRGBA_COLOR(@"#FF5EC6", 1.0);
    }else{
