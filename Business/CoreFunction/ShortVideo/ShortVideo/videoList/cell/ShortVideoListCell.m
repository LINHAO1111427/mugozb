...
- (void)createUI{
    ...
    UIImageView *bgImageV = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, self.width, self.height)];
    ...
    UITextField *likeTextfield = [[UITextField alloc]initWithFrame:CGRectMake(6, self.height-30+10, 60, 20)];
    ...
    UITextField *commentTextfield = [[UITextField alloc]initWithFrame:CGRectMake(self.width-66, 0, 60, 20)];
...
- (void)setModel:(ApiShortVideoDtoModel *)model{
    ...
    self.likeTextfield.text = [NSString stringWithFormat:@" %d", model.likes];
    self.commentTextfield.text = [NSString stringWithFormat:@" %d", model.comments];
