...
@class KLBannerView,ShopLiveAnnouncementDetailDTOModel;

@protocol KLBannerViewDelegate <NSObject>
 ...
 *  模型数组
 */
@property (nonatomic, strong) NSArray<ShopLiveAnnouncementDetailDTOModel *> *models;
/**
 *  代理，用来处理图片的点击
 */
@property (nonatomic, weak) id <KLBannerViewDelegate> delegate;
/**
 *  每一页停留时间，默认为3s，最少1s
 *  当设置的值小于1s时，则为默认值
 */
