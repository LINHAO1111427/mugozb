...
@interface AttentOrFansTableViewCell()
@property (nonatomic, assign)NSInteger type;//0关注 1密友 2粉丝 3备注 4群组
...
@end
@implementation AttentOrFansTableViewCell
...
- (void)setModel:(AppBookShowInfoVOModel *)model{
    ...
    [self.topImageV mas_updateConstraints:^(MASConstraintMaker *make) {
        make.width.mas_equalTo(model.isTop?30:0);
    }];
