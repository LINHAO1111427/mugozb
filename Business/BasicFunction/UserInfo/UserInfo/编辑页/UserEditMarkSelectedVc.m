...
static NSString *markCollectionViewCellId = @"EditMarkSelectedViewCellId";
@interface UserEditMarkSelectedVc ()<UICollectionViewDelegate,UICollectionViewDataSource>
...
@implementation UserEditMarkSelectedVc
...
- (NSArray *)markArray{
 ...
 - (UICollectionView *)markCollectionView{
     if (!_markCollectionView) {
         ...
         [_markCollectionView registerClass:[EditMarkSelectedViewCell class] forCellWithReuseIdentifier:markCollectionViewCellId];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    EditMarkSelectedViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:markCollectionViewCellId forIndexPath:indexPath];
