...
@interface LiveMainViewController ()<JXCategoryViewDelegate, JXCategoryListContainerViewDelegate>
...
- (void)viewDidLoad {
    ...
    UIBarButtonItem *soso = [[UIBarButtonItem alloc] initWithCustomView:[BaseNavBarItem navItemImageName:@"icon_nav_search_black" clickHandle:^{
        [RouteManager routeForName:RN_base_searchAnchorVC currentC:self];
    }]];
    
    self.navigationItem.rightBarButtonItems = @[publish, soso];
}
