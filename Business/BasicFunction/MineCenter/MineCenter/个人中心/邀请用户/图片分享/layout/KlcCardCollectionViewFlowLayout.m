...
#import "KLCConstant.h"

@implementation KlcCardCollectionViewFlowLayout
{
    NSInteger _index;
}
...
- (NSArray<UICollectionViewLayoutAttributes *> *)layoutAttributesForElementsInRect:(CGRect)rect
{
    ...
    for (UICollectionViewLayoutAttributes *attributes in visibleItemArray)
    {
        ...
        //5. 缩放
        attributes.transform3D = CATransform3DMakeScale(1 + scale * KlcMinZoomScale, 1 + scale * KlcMinZoomScale, 1);
