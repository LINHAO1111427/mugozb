...
- (void)addVisable:(CGFloat)height{
    ...
    whiteLayer.frame =CGRectMake(0,height+30,kScreenWidth,height);
    ...
    noDataTextLayer.frame  = CGRectMake(15,height+80, kScreenWidth-30, 20);
